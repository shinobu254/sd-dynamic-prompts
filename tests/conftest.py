...
@pytest.fixture
def monkeypatch_startfk(monkeypatch, tmp_path):
    """
    Patch sys.modules to look like we have a (partial) startfk installation.
    """
    import torch
    ...
    for module_name, contents in fake_startfk.items():
